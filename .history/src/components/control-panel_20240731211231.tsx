...
const reverseComponentNameMap = Object.fromEntries(
  Object.entries(componentNameMap).map(([key, value]) => [value, key])
);
...
function renderComponents(componentString) {
  ...
  if (match) {
    ...
    const fullComponentName = reverseComponentNameMap[componentName] || componentName;
