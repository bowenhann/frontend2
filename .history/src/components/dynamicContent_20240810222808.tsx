...
export const DynamicContent = ({ children }) => {
	...
	return (
		<div
    ref={((ref: HTMLDivElement | null) => ref && connect(drag(ref))) as React.LegacyRef<HTMLDivElement>}    // className="bg-yellow-100 p-4 min-h-[100px] m-2 border border-dashed border-yellow-300"
		>
