...
export const ResizableComponent = ({ width1 = '100%', height1 = '100%', children }) => {
  ...
  const pixelWidth = getPixelValue(width1, 'width');
  const pixelHeight = getPixelValue(height1, 'height');

  return (
    <div ref={containerRef} style={{ width: width1, height: height1 }}>
