    ...
    items: [
      {
        ...
        node: (
          <Element is={NodeAccordion} canvas>
            <Element is={NodeAccordionItem} canvas>
              <NodeAccordionTrigger>Accordion Trigger</NodeAccordionTrigger>
              <NodeAccordionContent>Accordion Content</NodeAccordionContent>
            </Element>
          </Element>
        ),
      },
