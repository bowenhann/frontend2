...
const createDraggableComponent = <P extends {}>(
  Component: React.ComponentType<P>
): Draggable<React.ComponentType<P>> => {
  const DraggableComponent: Draggable<React.ComponentType<P>> = (props: P) => {
    const { connectors: { connect, drag } } = useNode();
    return <Component ref={(ref: any) => connect(drag(ref))} {...props} />;
  };
