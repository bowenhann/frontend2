...
interface CraftComponent<T = any> extends React.FC { craft?: { displayName?: string; props?: Record<string, any>; related?: { toolbar?: React.ComponentType; }; custom?: Record<string, any>; }; }
