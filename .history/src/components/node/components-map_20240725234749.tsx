        ...
        node: (
          <Element
            ...
            items={[
              ...
              { triggerText: 'Is it styled?', contentText: 'Yes. It comes with default styles that matches the other components' aesthetic.', className: 'border-b' },
              { triggerText: 'Is it animated?', contentText: 'Yes. It's animated by default, but you can disable it if you prefer.', className: '' },
            ]}
          />
        ),
      },
