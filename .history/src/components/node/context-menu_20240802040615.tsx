...
import { NodeContextMenuSettings } from '@/components/settings/node-context-menu';
...
export const NodeContextMenu = ({
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger ref={(ref) => connect(drag(ref))} className="border p-4">
        {triggerText}
      </ContextMenuTrigger>
      <ContextMenuContent>
        {renderItems(items)}
...
NodeContextMenu.craft = {
  ...
  related: {
    toolbar: () => { NodeContextMenuSettings },
  },
};