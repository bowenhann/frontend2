...
const DynamicContent = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      const text = query.createNode(Text, { text: 'I am dynamic content!' });
      const button = query.createNode(Button, { text: 'Dynamic Button' });

      actions.add(text, id);
      actions.add(button, id);
    }, 2000); // 2秒延迟
  ...
  return (
    <div className="border-2 border-red-300 p-4 m-2">
