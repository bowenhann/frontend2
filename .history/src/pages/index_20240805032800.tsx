...
const DynamicContent = ({ items: initialItems }) => {
  ...
  return (
    <div ref={(ref) => connect(drag(ref))} style={{ padding: '10px', border: '1px solid black' }}>
...
const App = () => {
  return (
    <div>
      ...
      <Editor resolver={{ DynamicContent, EditableText }}>
        <Frame>
          <Element is={DynamicContent} canvas />
        </Frame>
      </Editor>
