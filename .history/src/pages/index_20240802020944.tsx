    ...
    <div style={{ height: '100%', overflow: 'auto', padding: '10px' }}>
      ...
      <Frame>
        <Element 
          is={Container} 
          canvas 
          ref={ref => create(ref, <Element is={Text} text="New Text" />)}
        >
          <Text text="Drag me to the right!" />
        </Element>
      </Frame>
    </div>
  );
  ...
  <div style={{ height: '100%', overflow: 'auto', padding: '10px' }}>
    ...
    <Frame>
      ...
      <Element is={DropZone} canvas>
        <Element is={Text} text="Dropped elements will appear here" />
      </Element>
			<Element>          <Element is={Text} text="Drag me!" />
			</Element>
    </Frame>
  </div>
);
...
const App = () => {
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      <h1>Craft.js with Cross-Panel Dragging</h1>
