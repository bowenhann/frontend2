...
const ContentUpdater = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const rootNodeId = Object.keys(currentNodes).find(id => currentNodes[id].data.type.resolvedName === 'Container');
      ...
      const newNodeId = `node${counter + 1}`;
      const updatedNodes = {
        ...currentNodes,
        [rootNodeId]: {
      ...
      console.log('Nodes after update:', query.getNodes());
    }, 2000);

    return () => clearInterval(interval);
  }, [actions, query, counter]);
