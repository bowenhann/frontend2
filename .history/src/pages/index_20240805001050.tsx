...
export default function Home() {
  return (
    <div className="p-4">
      ...
      <Editor resolver={{ Text, Button, Container, DynamicContent, NodeButton, StaticContent, ResizableComponent }}>
        <Frame>
          <Element is={StaticContent} canvas>
            <Element is={Text} text="Drag me around" />
            <Element is={Button} text="Draggable Button" />
            <Element is={DynamicContent} />
            <Element is={DynamicContent} />
						<ResizableComponent width='20%' height='20%'></ResizableComponent>
