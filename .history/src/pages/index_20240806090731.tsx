  ...
  useEffect(() => {
    const timer = setInterval(() => {
      try {
        ...
        // Method 1: Using actions.add
        // actions.add(newContentNode, dynamicContentId)

        // Method 2: Manually updating node structure and using deserialize
        // const updatedState = {
        //   ...parsedCurrentState,
        //   [newContentId]: newContentNode,
        // }
        // updatedState[dynamicContentId].nodes.push(newContentId)
        // actions.deserialize(updatedState)

        // Method 3: Using query.node().appendChild()
        query.node(dynamicContentId).appendChild(newContentNode)
