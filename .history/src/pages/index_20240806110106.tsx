  ...
  const buttonStrings = [
    ...
    const timer = setInterval(() => {
      try {
        ...
        if (!targetNodeId) {
          throw new Error('Could not find a suitable parent node');
        }
        ...
        console.log('New node tree:', newNodeTree);
        console.log(`Updating content, adding Stage ${stage + 1} to node ${targetNodeId}`);
