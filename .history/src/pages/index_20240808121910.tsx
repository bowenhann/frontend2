...
const ContentUpdater = () => {
  ...
  useEffect(() => {
    const addComponent = () => {
      ...
      try {
        const currentStageString = componentStages[stage];
        
        // Use renderComponents to parse the string into a React element
        const ComponentToAdd = renderComponents(currentStageString);
        ...
        // Parse the fresh node to create a valid node object
