  ...
  const buttonStrings = [
    ...
    const timer = setInterval(() => {
      try {
        ...
        // Find the DynamicContent node or a suitable parent node
        let targetNodeId = Object.keys(nodes).find(nodeId => 
          nodes[nodeId].data && nodes[nodeId].data.name && 
        ...
        console.log('New content tree:', newContentTree);

        actions.add(newContentTree[newNodeId], targetNodeId);
