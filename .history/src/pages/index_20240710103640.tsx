...
import {  FlexContainer, FlexItem, Resizer, ResizableFlexLayout } from '@/components/resizeableFlexContainer';
...
export default function Home() {
  return (
    <Editor resolver={{ FlexContainer, FlexItem }}>
      <Frame>
        <Element is={FlexContainer} canvas>
          <Element is={FlexItem} canvas>Item 1</Element>
          <Element is={FlexItem} canvas>Item 2</Element>
          <Element is={FlexItem} canvas>Item 3</Element>
        </Element>
      </Frame>
    </Editor>
  );
