...
const StaticComponent = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-2">This is a static component. You can drag me!</p>
      {children}
    </div>
  );
};
...
const DynamicContent = () => {
  ...
  //         props.children = "This is dynamically added content. You can drag me too!";
  //       });
...
export default function Home() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Craft.js Drag and Dynamic Content Demo</h1>
