  ...
  useEffect(() => {
    const addComponent = () => {
      ...
      try {
        ...
        // Parse the string to a React element
        const parsedElement = renderComponents(currentComponentString);
        
        // Create a unique id for this element
        const uniqueId = `element_${stage}_${Date.now()}`;
        
        // Create a node tree with Element wrapper to ensure canvas and draggable properties
        const nodeTree = query.parseReactElement(
          <Element canvas id={uniqueId}>
            {parsedElement}
          </Element>
        ).toNodeTree();
