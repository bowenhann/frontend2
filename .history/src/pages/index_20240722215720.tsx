...
function renderComponents(componentsString) {
  ...
  while ((match = regex.exec(componentsString))) {
    ...
    if (Component) {
      ...
      if (name === 'Element') {
        // Extract width and height from Element props
        ...
        components.push(
          React.createElement(
            ...
            React.createElement(ResizableComponent, 
              { 
                width: width || 'auto', 
                height: height || 'auto',
                ...restProps,
                is: undefined // Remove 'is' prop as it's not needed for ResizableComponent
              }, 
              props.children
            )
          )
