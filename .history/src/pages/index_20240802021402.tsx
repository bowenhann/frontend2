...
const Toolbar = () => {
  ...
  return (
    <div style={{ padding: '10px', borderBottom: '1px solid #ddd' }}>
      ...
      <button
        ref={ref => connectors.create(ref, <Container><Text text="New Container" /></Container>)}
      >
        Add Container
      </button>
    </div>
...
const LeftPanel = () => {
  return (
    <div style={{ height: '100%', overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
      <h2 style={{ padding: '10px' }}>Toolbar</h2>
      <Toolbar />
      <div style={{ flex: 1, padding: '10px' }}>
        <h3>Drag these elements:</h3>
        <Element is={Text} text="Drag me to the right!" />
        <Element is={Container}>
          <Text text="Container with text" />
        </Element>
      </div>
    </div>
  );
...
const RightPanel = () => (
  <div style={{ height: '100%', overflow: 'auto', padding: '10px' }}>
    <h2>Drop Zone</h2>
    <Frame>
      <Element is={DropZone} canvas>
        <Text text="Drop elements here" />
      </Element>
    </Frame>
  </div>
);
...
const App = () => {
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      <h1 style={{ padding: '10px' }}>Craft.js with Distinct Drag and Drop Zones</h1>
      <Editor resolver={{ Text, Container, DropZone }}>
