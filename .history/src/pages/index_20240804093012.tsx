...
const Container = () => {
  ...
  return (
    <div 
      ...
      className="border-2 border-dashed border-gray-300 p-4 m-2"
    >
      <h2 className="text-xl font-bold mb-2">Draggable Container</h2>
      <p className="mb-4">This is a draggable and duplicatable container.</p>
      <button
