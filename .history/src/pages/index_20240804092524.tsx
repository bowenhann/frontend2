...
const SimpleDiv = ({ children, background, padding }) => {
...
const AddChildButton = () => {
  ...
  const handleAddChild = () => {
    ...
    const newNode = query.createNode(React.createElement(SimpleDiv, {
...
const DynamicContent = () => {
  ...
  return (
    <div ref={connect}>
      <SimpleDiv background="lightgreen" padding={20}>
        This is the root SimpleDiv
      </SimpleDiv>
    </div>
  )
}
