    ...
    switch (type) {
      ...
      case 'button':
        if (buttonString) {
          ...
          return React.Children.map(buttonComponent, (child, index) => (
            <Element id={`${id}_button_${index}`} is={NodeButton} canvas={false}>
              {child}
            </Element>
          ));
        }
...
const App = () => {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Simplified Draggable Components Demo</h1>
