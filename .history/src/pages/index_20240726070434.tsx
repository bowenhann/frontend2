...
const ComponentWrapper = ({ children, ...props }) => {
  ...
  const handleClick = (e) => {
    ...
    const componentCode = getOutputCode({ [id]: nodes[id] });
    console.log(`Clicked component (${nodes[id].data.displayName}) code:`);
    console.log(componentCode.importString);
    console.log(componentCode.output);
  };
...
// Wrap each component with the ComponentWrapper
...
// Modify your component map to wrap each component
const wrappedComponentMap = Object.entries(componentMap).reduce((acc, [key, Component]) => {
	...
	return (
		<section className="w-full min-h-screen flex flex-col">
			...
			<Editor
				...
				// 	NodeAlertDialog
				// }}
				resolver={{...wrappedComponentMap, Canvas, ResizableComponent}} // Use the wrapped components
