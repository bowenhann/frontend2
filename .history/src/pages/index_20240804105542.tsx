...
const DynamicContent = () => {
  ...
  React.useEffect(() => {
    const addComponents = () => {
      ...
      const mainComponent = query.createNode(React.createElement(SimpleComponent));
      actions.add(mainComponent, 'ROOT');

      // Add two buttons to the main component
      const button1 = query.createNode(React.createElement(Button));
      const button2 = query.createNode(React.createElement(Button));
      actions.add(button1, mainComponent.id);
      actions.add(button2, mainComponent.id);
    };
