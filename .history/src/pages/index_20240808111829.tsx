...
const ContentUpdater = () => {
  ...
  const [newContentNodeId, setNewContentNodeId] = useState(null);
    ...
    const addOrUpdateNewContent = () => {
      if (!newContentNodeId) {
				console.log('waaa', newContentNodeId)
        ...
        const nodeId = actions.add(node, 'ROOT');
				console.log('saaa', nodeId)
        setNewContentNodeId(nodeId);
        console.log('Added new NewContent node with ID:', nodeId);
      } else {
