...
const DashboardLayout = ({ children }) => (
  <div className="flex flex-wrap gap-4" style={{ height: '100vh', padding: '20px' }}>
    {children}
  </div>
);
    ...
    const addDynamicContent = () => {
      ...
      try {
        ...
        actions.setProp(linkedNodeId, (props) => {
          props.children = (
            <DashboardLayout>
              <ResizableComponent width="95%" height="10%" className="flex-grow">
                <div className="bg-gray-800 text-white p-4 h-full">
                  <h1 className="text-2xl font-bold">My Application</h1>
                </div>
              </ResizableComponent>
              <ResizableComponent width="32%" height="50%" className="flex-grow">
                <NodeCalendar className="p-4 h-full" />
              </ResizableComponent>
              <ResizableComponent width="20%" height="50%" className="flex-grow">
                <NodeButton className="bg-red-500 text-white px-4 py-2 rounded">
                  Button 1
                </NodeButton>
              </ResizableComponent>
              <ResizableComponent width="20%" height="50%" className="flex-grow">
                <div className="h-full flex flex-col">
                  <NodeButton className="mb-2">Button 2</NodeButton>
                  <ResizableComponent width="100%" height="50%" className="flex-grow">
                    <NodeButton className="bg-red-500 text-white px-4 py-2 rounded">
                      Button 1
                    </NodeButton>
                  </ResizableComponent>
              ...
              <ResizableComponent width="95%" height="35%" className="flex-grow">
                <NodeCard className="p-6 m-2 h-full">
                  <NodeCardHeader>
                    <NodeCardTitle className="bg-blue-500 text-white px-4 py-2 rounded">
                      Card Title
                    </NodeCardTitle>
                    <NodeCardDescription className="bg-blue-500 text-white px-4 py-2 rounded mt-2">
                      Card Description
                    </NodeCardDescription>
                  </NodeCardHeader>
                  <NodeCardContent className="my-4">Card Content</NodeCardContent>
                  <NodeCardFooter>
                    <NodeButton>Footer button</NodeButton>
                  </NodeCardFooter>
                </NodeCard>
...
NodeCard.craft = { displayName: 'Node Card' };
NodeCardHeader.craft = { displayName: 'Node Card Header' };
NodeCardTitle.craft = { displayName: 'Node Card Title' };
NodeCardDescription.craft = { displayName: 'Node Card Description' };
NodeCardContent.craft = { displayName: 'Node Card Content' };
NodeCardFooter.craft = { displayName: 'Node Card Footer' };
DashboardLayout.craft = { displayName: 'Dashboard Layout' };
