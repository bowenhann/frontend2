  ...
  useEffect(() => {
    const timer = setInterval(() => {
      try {
        ...
        if (stage === 0) {
          // For the first stage, create a new NewContent node
          ...
          // For subsequent stages, update the existing NewContent node
          ...
          newState = {
            ...
            [newContentId]: {
              ...
              props: {
                ...parsedCurrentState[newContentId].props,
                buttonString: parsedCurrentState[newContentId].props.buttonString + buttonStrings[stage]
              }
            }
          }
        }
