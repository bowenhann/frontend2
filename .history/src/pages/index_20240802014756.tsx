  ...
  return (
    <div style={{ width: '100%', height: '400px' }}>
      <PanelGroup direction="horizontal">
        <Panel minSize={20}>
          <Element is={PanelContent} canvas>
            <StaticText />
            <Element is={Text} text="Draggable Item 1" />
            <Element is={Text} text="Draggable Item 2" />
          </Element>
        </Panel>
        <PanelResizeHandle />
        <Panel minSize={20}>
          <Element is={PanelContent} canvas>
            <Element is={Text} text="Draggable Item 3" />
            <Element is={Text} text="Draggable Item 4" />
          </Element>
        </Panel>
      </PanelGroup>
    </div>
