    ...
    const timer = setInterval(() => {
      try {
        ...
        const findDynamicContent = (nodeId) => {
          ...
          if (node.data && node.data.displayName === 'Dynamic Content') {
            return nodeId;
          }

          const childNodes = node.data && node.data.nodes ? node.data.nodes : [];
        ...
        const newContentNode = {
          data: {
            type: 'ResizableComponent', // Use the actual component name that exists in your resolver
            props: {
              width: "95%",
              height: "10%",
              children: buttonStrings[stage]
            },
            displayName: 'Dynamic Content Container',
            custom: {},
            hidden: false,
