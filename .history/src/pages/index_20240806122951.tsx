  ...
  useEffect(() => {
    const timer = setInterval(() => {
      try {
        ...
        // Check if ROOT has a nodes array
        if (!Array.isArray(rootNode.data.nodes)) {
          console.warn('ROOT node does not have a nodes array. Initializing it.');
        ...
        if (updatedRootNode) {
          ...
          console.error('Failed to get updated ROOT node');
        }
