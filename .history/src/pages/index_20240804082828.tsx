...
const buttonStringChunks = splitIntoChunks(fullButtonString);
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (chunkIndex < buttonStringChunks.length) {
        setButtonString(prevString => prevString + buttonStringChunks[chunkIndex]);
        chunkIndex++;
      } else {
...
export default function Home() {
  const [components, setComponents] = useState(renderComponents(buttonString))
  const iframeRef = useRef(null)
