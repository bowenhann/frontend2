    ...
    const timer = setInterval(() => {
      ...
      try {
        ...
        actions.setProp('dynamic_content_container', (props) => {
          props.buttonStrings = buttonStrings.slice(0, stage + 2);
          props.stage = stage + 1;
        });
        ...
        setTimeout(() => {
          const updatedNode = query.node('dynamic_content_container').get();
          console.log('Updated dynamic_content_container structure:', safeStringify(updatedNode));
        }, 0);
      } catch (error) {
