...
const ContentUpdater = () => {
  ...
  const buttonStrings = [
    // ... (your button strings remain the same)
  ];

  useEffect(() => {
    // Add initial NewContent component if it doesn't exist
    const addInitialNewContent = () => {
      ...
      if (!existingNewContent) {
        ...
        actions.selectNode('NEW_CONTENT');
      }
    };

    addInitialNewContent();
    ...
    const timer = setInterval(() => {
      ...
      try {
        ...
        actions.setProp('NEW_CONTENT', (props) => {
          props.stage = stage + 1;
        });
