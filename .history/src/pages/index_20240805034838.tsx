...
// ContentUpdater component (unchanged)
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      try {
        ...
        const dynamicContentId = Object.keys(parsedCurrentState).find(
          key => key !== 'ROOT' && parsedCurrentState[key].type.resolvedName === 'DynamicContent'
        );
...
const App = () => {
  return (
    <div>
      ...
      <Editor resolver={{ DynamicContent, TextBox, Container }}>
        <Frame>
          <Element is={Container} canvas>
            <Element is={DynamicContent} canvas>
              <DynamicContent content="Initial Content (I will change)" />
            </Element>
