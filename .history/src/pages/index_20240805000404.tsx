...
export default function Home() {
  return (
    <div className="p-4">
      ...
      <Editor resolver={{ Text, Button, Container, DynamicContent, NodeButton, StaticContent }}>
        <Frame>
          <Element is={Container} canvas>
            ...
            <Element is={DynamicContent} />
            <Element is={StaticContent}>
              <Element is={NodeButton} id={'11'} className="bg-purple-500 text-white px-4 py-2 rounded">
