...
const DynamicContent = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsButton(true);
      actions.transform(id, NodeButton, { text: "I'm a dynamic button" });
      console.log('Dynamic content transformed to NodeButton');
    }, 2000);
  ...
  if (isButton) {
    return null; // The NodeButton will be rendered by Craft.js
  }
...
export default function Home() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Craft.js Dynamic Content to NodeButton Demo</h1>
