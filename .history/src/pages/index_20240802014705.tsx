...
const ResizableContainer = ({ children }) => {
  const { connectors: { connect } } = useNode();
  return (
    <div ref={connect} style={{ width: '100%', height: '400px' }}>
        ...
        <Frame>
          <Element is={ResizableContainer} canvas>
            <Element is={PanelContent} canvas>
              <Text text="Drag me in left panel" />
              <Text text="Another draggable in left" />
              <Text text="One more in left panel" />
            </Element>
            <Element is={PanelContent} canvas>
              <Text text="Drag me in right panel" />
              <Text text="Another draggable in right" />
              <Text text="One more in right panel" />
            </Element>
          </Element>
        </Frame>
      </Editor>
