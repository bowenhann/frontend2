  ...
  const buttonStrings = [
    ...
    const timer = setInterval(() => {
      try {
        ...
        console.log('ROOT node details:', JSON.stringify(rootNode, null, 2));

        // Find the first child of ROOT or use ROOT itself
        const targetNodeId = rootNode.data.nodes[0] || 'ROOT';
        ...
        try {
          console.log(`Attempting to add node to ${targetNodeId}`);
