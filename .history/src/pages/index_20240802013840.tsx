...
const ResizableContainer = ({ children }) => {
  ...
  return (
    <div ref={(ref) => connect(drag(ref))} style={{ border: '1px solid black', margin: '10px' }}>
      <PanelGroup direction="horizontal">
        <Panel minSize={20}>
          <div style={{ padding: '10px' }}>{children[0]}</div>
        </Panel>
        <PanelResizeHandle />
        <Panel minSize={20}>
...
export const CombinedDemo = () => {
  return (
    <div>
      <h1>Combined Craft.js and react-resizable-panel Demo</h1>
