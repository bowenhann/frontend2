...
const StaticComponent = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-2">This is a static component (draggable)</p>
      {children}
    </div>
  );
};
...
const DynamicContent = () => {
  ...
  const updateContent = useCallback(() => {
    setProp((props) => (props.children = "This is dynamically added content (draggable)"));
  }, [setProp]);
...
export default function Home() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Craft.js Dynamic Content with Drag Demo</h1>
