...
const DynamicContent = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      console.log('Dynamic NodeButton added');
    }, 2000);
  ...
  return (
    <div 
      ref={ref => connect(drag(ref))}
      className="bg-yellow-100 p-2 m-2 rounded min-h-[50px]"
    >
...
export default function Home() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Craft.js Dynamic NodeButton Addition Demo</h1>
