  ...
  return (
    <div style={{ width: '100%', height: '400px' }}>
      <PanelGroup direction="horizontal">
        <Panel minSize={20}>
          <div style={{ padding: '10px', height: '100%', background: '#f0f0f0', overflow: 'auto' }}>
            {children[0]}
          </div>
        </Panel>
        <PanelResizeHandle style={{ width: '10px', background: '#ccc' }} />
        <Panel minSize={20}>
          <div style={{ padding: '10px', height: '100%', background: '#e0e0e0', overflow: 'auto' }}>
            {children[1]}
          </div>
        </Panel>
      </PanelGroup>
      ...
      <Editor resolver={{ Text, ResizableContainer }}>
        <Frame>
          <Element is={ResizableContainer} canvas>
            <Element canvas>
              <Element is={Text} text="Drag me in left panel" />
              <Element is={Text} text="Another draggable in left" />
              <Element is={Text} text="One more in left panel" />
            </Element>
            <Element canvas>
              <Element is={Text} text="Drag me in right panel" />
              <Element is={Text} text="Another draggable in right" />
              <Element is={Text} text="One more in right panel" />
            </Element>
          </Element>
        </Frame>
      </Editor>
