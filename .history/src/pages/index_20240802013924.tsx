...
// Craft.js compatible wrapper for PanelGroup
const CraftPanelGroup = ({ children, ...props }) => {
...
// Craft.js compatible wrapper for Panel
...
// Craft.js compatible wrapper for PanelResizeHandle
const CraftPanelResizeHandle = (props) => {
  const { connectors: { connect } } = useNode();
  return <PanelResizeHandle ref={connect} {...props} />;
};
...
const App = () => {
  return (
    <div style={{ margin: '20px', border: '1px solid #ccc', padding: '20px' }}>
      <h1>Craft.js with react-resizable-panels Demo</h1>
      <Editor resolver={{ CraftPanelGroup, CraftPanel, CraftPanelResizeHandle, Text }}>
        <Frame>
          <Element is={CraftPanelGroup} canvas direction="horizontal">
            <Element is={CraftPanel} canvas minSize={20}>
              <Text text="Left Panel" />
              <Element is={Text} text="Drag me!" />
            </Element>
            <Element is={CraftPanelResizeHandle} />
            <Element is={CraftPanel} canvas minSize={20}>
              <Text text="Right Panel" />
              <Element is={Text} text="Drag me too!" />
            </Element>
          </Element>
        </Frame>
      </Editor>
