...
const buttonString1 = `<NodeButton className="bg-purple-500 text-white px-4 py-2 rounded">
...
export default function Home() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Craft.js Drag and Drop with Dynamic and Static Content Demo</h1>
      <Editor resolver={{ Text, Button, Container, DynamicContent, NodeButton, StaticContent, Canvas, ResizableComponent }}>
        <Frame>
				<Element
                  is={Canvas}
                  id="ROOT"
