    ...
    if (Component) {
      ...
      while ((attributeMatch = attributeRegex.exec(attributes))) {
        ...
        if (name === 'className') {
          ...
          props.is = componentMap[value] || value;
        } else {
      ...
      if (tagName === 'Element') {
        ...
        WrappedComponent.displayName = `Craft${tagName}`;
        components.push(
          React.createElement(WrappedComponent, { key: components.length, ...props })
        );
      }
    } else {
