    ...
    const timer = setInterval(() => {
      try {
        ...
        const findDynamicContent = (nodeId) => {
          ...
          // Check if the current node is DynamicContent
          if (node.data.displayName === 'Dynamic Content' || 
              node.data.name === 'DynamicContent' || 
              node.data.type === 'DynamicContent') {
            return nodeId;
          }
        ...
        // Use add instead of addNodeTree
