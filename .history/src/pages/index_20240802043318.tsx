...
const buttonString2 = `
<ResizableComponent width='100%' height='100%'><div className='bg-light-blue-100 p-4'><h1 className='text-xl font-medium'>Detail Mode Interface</h1><div className='space-x-2'><NodeButton className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600'>Details 1</NodeButton><NodeButton className='bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600'>Details 2</NodeButton><NodeButton className='bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600'>Details 3</NodeButton><NodeButton className='bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600'>Details 4</NodeButton><NodeButton className='bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600'>Details 5</NodeButton></div></div></ResizableComponent>
`;
