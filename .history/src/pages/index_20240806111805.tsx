  ...
  useEffect(() => {
    const timer = setInterval(() => {
      try {
        ...
        console.log('All nodes:', JSON.stringify(nodes, null, 2));
        ...
        console.log('New node tree:', JSON.stringify(newNodeTree, null, 2));
        ...
        setTimeout(() => {
          ...
          console.log('Updated nodes after adding:', JSON.stringify(updatedNodes, null, 2));
