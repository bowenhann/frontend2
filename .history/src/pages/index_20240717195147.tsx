			...
			>
				<div className="flex flex-1 relative overflow-hidden">
                  ...
                  <NodeButton>Button 4</NodeButton> */}
									...
									<Element is={ResizableComponent}  width1 = '10%' height1 = '10%' canvas>
										Button 1
									</Element>
									<Element is={ResizableComponent}  width1 = '10%' heigh1 = '10%' canvas>
										Button 1
									</Element>
									<Element is={ResizableComponent}  width1 = '10%' height = '10%' canvas>
										Button 1
									</Element>
								</Element>
							</Frame>
