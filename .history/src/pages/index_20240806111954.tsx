  ...
  useEffect(() => {
    const timer = setInterval(() => {
      try {
        ...
        if (!targetNodeId) {
          console.log('No suitable target node found, using ROOT');
          targetNodeId = 'ROOT';
        }
        ...
        const parentNode = query.node(targetNodeId).get();
        if (parentNode) {
          actions.setCustom(targetNodeId, {
            ...parentNode.data.custom,
            nodes: [...(parentNode.data.nodes || []), newNodeId]
          });
        }
        ...
        setTimeout(() => {
          ...
          if (updatedNodes[newNodeId]) {
            ...
            console.log('Failed to add new node');
          }
        }, 0);
