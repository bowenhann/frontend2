...
const ContentUpdater = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      // Create a new Text node using query.createNode()
      const newNode = query.createNode({
        data: { type: Text, props: { text: 'New Text' } }
      });
      ...
      console.log('Nodes after adding new node:', JSON.stringify(query.getNodes(), null, 2));
    }, 2000);
...
const App = () => {
  return (
    <Editor
      ...
      onNodesChange={query => {
        console.log('Nodes changed:', JSON.stringify(query.getNodes(), null, 2));
      }}
    >
      <Frame>
