...
const ContentUpdater = () => {
  ...
  useEffect(() => {
    const addComponent = () => {
      ...
      try {
        const currentStageString = componentStrings[stage];
        const componentConfig = stringToComponentConfig(currentStageString);

        if (!componentConfig) {
          console.error('Failed to parse component string:', currentStageString);
          return;
        }
