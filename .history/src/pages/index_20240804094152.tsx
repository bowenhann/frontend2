...
const Container = ({ children }) => {
  ...
  return (
    <div ref={(dom) => connect(drag(dom))} className="border border-gray-300 p-4 m-2">
      ...
      <button
        ...
        onClick={() => {
          ...
          const newNode = createNode(React.createElement(type, { ...props, children: null }));
          add(newNode, node(id).parent().get().id);
        }}
      >
        Make a copy of me
      </button>
