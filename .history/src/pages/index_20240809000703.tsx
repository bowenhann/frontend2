...
const ContentUpdater = () => {
  ...
  const wrapWithElement = (component) => {
    ...
    if (Array.isArray(children)) {
      wrappedChildren = children.map(wrapWithElement);
    } else if (children && typeof children === 'object') {
      wrappedChildren = wrapWithElement(children);
    } else {
    ...
    const addComponent = () => {
      ...
      try {
        ...
        parsedComponents.forEach((parsedComponent) => {
          const wrappedComponent = wrapWithElement(parsedComponent);
