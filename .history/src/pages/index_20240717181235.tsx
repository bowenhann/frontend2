          ...
          NodeCalendar, // 新增 Calendar 组件
			...
			>
                ...
                <Element is={ResizableComponent} canvas>
                    <Element is={NodeButton} canvas>Button 1</Element>
                    <Element is={NodeButton} canvas>Button 2</Element>
                    <Element is={NodeCard} canvas className="p-6 m-2">
                      <Element is={NodeCardHeader} canvas>
                        <Element is={NodeCardTitle} canvas>Card Title</Element>
                        <Element is={NodeCardDescription} canvas>Card Description</Element>
                      </Element>
                      <Element is={NodeCardContent} canvas>Card Content</Element>
                      <Element is={NodeCardFooter} canvas>
                        <Element is={NodeButton} canvas>Footer button</Element>
                      </Element>
                    </Element>
                    <Element is={NodeCalendar} canvas className="p-4" />
                  </Element>
