...
const NewContent = ({ content, type, className, componentString }) => {
  ...
  const renderContent = () => {
    switch (type) {
      ...
      case 'component':
        return renderComponents(componentString);
      default:
        return <div className={className}>{content}</div>;
    }
  };
    ...
    const timer = setTimeout(() => {
      try {
        ...
        const componentString = `
          <ResizableComponent width="25%" height="25%" canvas>
            <NodeButton className="bg-purple-500 text-white px-4 py-2 rounded">
              Static Container Button
            </NodeButton>
          </ResizableComponent>
        ...
        // Create two new NewContent nodes: one text and one component
        const newContentTextId = `NewContent_Text_${Date.now()}`;
        const newContentComponentId = `NewContent_Component_${Date.now()}`;
        ...
        const newState = {
          ...
          [newContentComponentId]: {
            ...
            displayName: 'New Content Component',
            custom: {},
            hidden: false,
            nodes: [],
            linkedNodes: {},
        ...
        console.log('Updating content, adding NewContent (Text and Component) to DynamicContent');
...
const App = () => {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Extended Draggable Components Demo</h1>
