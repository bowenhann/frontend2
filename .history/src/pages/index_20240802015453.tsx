...
const Container = ({ children }) => {
  ...
  return (
    <div 
      ...
      style={{ padding: '10px', margin: '5px', border: '1px solid black', minHeight: '50px' }}
    >
      {children}
    </div>
  );
...
const ResizableContainer = ({ children }) => {
  ...
  return (
    <div ref={(ref) => connect(drag(ref))} style={{ width: '100%', height: '400px', border: '2px solid blue', margin: '10px 0' }}>
...
const App = () => {
  return (
    <div style={{ margin: '50px' }}>
      <h1>Craft.js with Resizable Panels and Nested Elements</h1>
        ...
        <Frame>
          <Element is={ResizableContainer} canvas>
            <Element is={Container} canvas>
              ...
              <Element is={Container} canvas>
                <Element is={Text} text="Deeply nested text" />
              </Element>
            </Element>
            <Element is={Container} canvas>
