...
const Example = () => {
  ...
  return (
    <div>
      <button onClick={(e) => {
        e.preventDefault();
        console.log("Button 1 clicked: Add a new Node from a React Element");
        const nodeTree = query.parseReactElement(<H2>Hi</H2>).toNodeTree();
        console.log("Node tree created:", nodeTree);
        actions.addNodeTree(nodeTree, 'ROOT');
        console.log("Node tree added to ROOT");
      }}>
      ...
      <button onClick={(e) => {
        e.preventDefault();
        console.log("Button 2 clicked: Add a new Node from a Node object");
        const freshNode = {
            data: {
                type: Text,
                props: {
